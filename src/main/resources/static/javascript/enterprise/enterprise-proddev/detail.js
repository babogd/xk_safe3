...
$(function () {
    ...
    */
            ...
            G.ajax({
                ...
                success: function(resultData) {
                    if (typeof resultData.data !== 'undefined') {
                        ...
                        //放入危化品配置
                        grid.datagrid('loadData', resultData.data.proddevCfgList);
                    }
                }
            });
        }
        ...
        return {
            apiInsert: '/api/enterprise/enterprise-proddev/insert',
            apiUpdate: '/api/enterprise/enterprise-proddev/update',
            apiOne: '/api/enterprise/enterprise-proddev/one',
